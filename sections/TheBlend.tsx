  ...
  return (
    <Section id="blend" className="bg-elevated/40">
      ...
      <Reveal stagger className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {mushrooms.map((m, i) => (
          <RevealItem key={m.id}>
            <article className="group relative h-full overflow-hidden rounded-3xl border border-line bg-base/60 p-7 transition-colors [text-shadow:0_2px_16px_rgba(5,2,15,0.95)] hover:border-accent/40">
